...
const AboutSchool = () => {
    return (
        <section className="bg-[#FAFAFA]  text-[#3B82F6] px-6 md:px-12 lg:px-24 py-16 pt-[150px]">
            <motion.div
            ...
            >
                <h2 className="text-3xl font-bold flex justify-center items-center gap-2">
                    <FaSchool className="text-[#3B82F6]" /> About Our School
                </h2>
            </motion.div>

            <motion.p
                className="text-lg text-[#2D2D2D] max-w-3xl mx-auto text-center leading-relaxed"
                initial={{ opacity: 0 }}
