...
const Footer = () => {
  return (
    <footer className="bg-[#103d8d] text-white pt-12 pb-6 px-6 md:px-12 lg:px-24">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-10 mb-10 animate-fade-in">
        ...
        <div className="md:w-1/2">
          ...
          {/* Social Media Icons (white, no bg) */}
      ...
      {/* Bottom Bar */}
      <div className="border-t border-white pt-4 text-xs text-white flex flex-col md:flex-row justify-between items-center animate-fade-in">
